...
'{"creativity": 9, "brutality": 9, "accuracy": 8}'::jsonb,
false, 'The Algorithm',
'{"💀":89,"🔥":67,"😈":44,"😬":12,"👏":5,"😭":55}'::jsonb,
8.4),
...
'{"creativity": 8, "brutality": 7, "accuracy": 9}'::jsonb,
false, 'SwipeLeft4Ever',
'{"💀":55,"🔥":102,"😈":38,"😬":67,"👏":3,"😭":88}'::jsonb,
8.1),
...
'{"creativity": 10, "brutality": 10, "accuracy": 9}'::jsonb,
false, 'Y Combinator Reject',
'{"💀":201,"🔥":178,"😈":155,"😬":8,"👏":2,"😭":33}'::jsonb,
9.2),
...
'{"creativity": 6, "brutality": 6, "accuracy": 9}'::jsonb,
false, 'Unemployed in Melbourne',
'{"💀":34,"🔥":28,"😈":19,"😬":77,"👏":44,"😭":22}'::jsonb,
6.8),
...
'{"creativity": 8, "brutality": 7, "accuracy": 8}'::jsonb,
false, 'Main Character Energy',
'{"💀":66,"🔥":71,"😈":50,"😬":29,"👏":8,"😭":41}'::jsonb,
7.9);